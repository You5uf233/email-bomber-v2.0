...
class EmailBomber:
    ...
    def __init__(self):
        ...
        try:
            print(self.b + '\n[+] Initializing bomber ...')
            self.target = str(input(self.g + '[:] Yousuf.habibzai@gmail.com > '))
            self.mode = int(input(self.g + '[:] 4 || 1:(1000) 2:(500) 3:(250) 4:(custom) > '))
    ...
    def email(self):
        try:
            print(self.b + '\n[+] Setting up email ...')
            self.server = str(input(self.g + '[:] 1 > '))
            defaultPort = True
            ...
            self.fromAddr = str(input(self.g + '[:] haveagoodday@gmail.com > '))
